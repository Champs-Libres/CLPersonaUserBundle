...
namespace CL\PersonaUserBundle\Templating\Helper;
...
//    }
    ...
    public function loginButton($parameters = array(), $name = null)
    {
        ...
        $name = $name ?: 'CLPersonaUserBundle::userButton.html.twig';
        return $this->templating->render($name, $parameters + array(
        ));
    }
    
    public function logoutButton($parameters = array(), $name = null) {
        $name = $name ?: 'CLPersonaUserBundle::userLogoutButton.html.twig';
        return $this->templating->render($name, $parameters + array());
    }
